...
apt install -y python-pip git python3-jinja2

# install the libcamera dependencies
apt install -y libboost-dev
apt install -y libgnutls28-dev openssl libtiff-dev pybind11-dev
apt install -y qtbase5-dev libqt5core5a libqt5widgets
apt install -y meson cmake
apt install -y python3-yaml python3-ply
